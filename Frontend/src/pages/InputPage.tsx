...
import {
  buildAnswerKeyInstruction,
  buildWorksheetFormatInstruction,
  getGradeLevelGuidance,
} from "@/lib/gradeGuidance";
...
const QUESTION_CONTROLS = [
  ...
  {
    key: "oneMarkQuestions",
    label: "One word / one sentence",
    hint: "Section B - 1 mark",
    min: 0,
    max: 10,
  },
  {
    key: "twoMarkQuestions",
    label: "Short answer questions",
    hint: "Section C - 2 marks",
    min: 0,
    max: 10,
  },
  {
    key: "fiveMarkQuestions",
    label: "Long answer questions",
    hint: "Section D - 5 marks",
    min: 0,
    max: 10,
  },
] as const;
...
export default function InputPage() {
  ...
  const submit = async (e: FormEvent) => {
    ...
    const timeout = setTimeout(() => {
      setLoading(false);
      setSubmitErr("Request timed out. Please try again.");
    }, 90000);
    try {
    ...
    <div className="min-h-screen relative">
      ...
      <main className="relative max-w-3xl mx-auto px-4 sm:px-6 py-10">
        <div className="text-center mb-10">
          <div className="inline-block text-xs text-blue-300 bg-white/10 backdrop-blur border border-white/20 rounded-full px-4 py-2 mb-6">
          ...
          <p className="text-blue-200 text-base sm:text-lg mt-4 max-w-xl mx-auto">
            Generate professional lesson plans, worksheets, quizzes and answer keys in 20 seconds.
          </p>
        </div>

        <div
          className="relative rounded-[28px] border border-white/10 backdrop-blur-xl p-6 sm:p-10"
        ...
        >
          ...
          <p className="text-blue-200 text-sm mb-6">
            Fill in the details and we'll generate everything you need.
          </p>
          ...
          <form onSubmit={submit} className="space-y-5">
            <label className="block">
              ...
              <select
                ...
                style={{
                  ...
                  border: `1px solid ${errors.grade ? "rgb(248,113,113)" : "rgba(255,255,255,0.12)"}`,
                }}
              >
            ...
            <label className="block">
              ...
              <select
                ...
                style={{
                  background: "rgba(255,255,255,0.06)",
                  border: `1px solid ${errors.subject ? "rgb(248,113,113)" : "rgba(255,255,255,0.12)"}`,
                }}
              >
                <option value="" className="bg-slate-900">
                  {form.grade ? "Select subject" : "Select grade first"}
                </option>
            ...
            <label className="block">
              ...
              <textarea
                ...
                style={{
                  background: "rgba(255,255,255,0.06)",
                  border: `1px solid ${errors.objectives ? "rgb(248,113,113)" : "rgba(255,255,255,0.12)"}`,
                }}
              />
              {errors.objectives && (
                <span className="text-xs text-red-300 mt-1 block">Required</span>
              )}
            </label>
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    Choose number of Questions to be generated in worksheet.
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              {form.language === "Hindi" && (
                <div className="inline-block mt-2 text-xs text-blue-300 bg-blue-900/30 rounded px-3 py-1">
            ...
            {loading ? (
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: "0 8px 30px rgba(30,111,217,0.5)",
                }}
              >
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        style={{
          background: "rgba(255,255,255,0.06)",
          border: `1px solid ${error ? "rgb(248,113,113)" : "rgba(255,255,255,0.12)"}`,
        }}
      />
