...
const GRADE_GUIDANCE: Record<number, Omit<GradeLevelGuidance, "grade">> = {
  1: {
    ...
    recommended_question_types:
      "Picture-based recognition, simple multiple choice with 2-3 options, one-to-one matching, fill-in-the-blank with word bank, copy/trace words, and very short one-word or phrase responses.",
  },
  2: {
    target_thinking_level: "Remember / Understand with introduction to simple Apply, DOK 1-2.",
    recommended_question_types:
      "Multiple choice with 3 options, matching word-definition or question-answer pairs, short fill-in-the-blank, true/false, sequencing items, and very short why/how questions with one-sentence answers.",
  },
  3: {
    target_thinking_level: "Understand / Apply with simple Analyze, DOK 1-2.",
    recommended_question_types:
      "Standard MCQ with 3-4 options, multi-step word problems, short answers of 1-2 sentences explaining reasoning, matching with extra choices, sorting/classifying, and simple graphic organizers.",
  },
  4: {
    target_thinking_level: "Apply / basic Analyze, with some DOK 2-3 items.",
    recommended_question_types:
      "Best-answer MCQs with plausible distractors, short constructed responses of 2-3 sentences, explain-your-thinking follow-ups, compare/contrast questions, data interpretation from charts/tables, and cause-effect questions.",
  },
  5: {
    target_thinking_level: "Apply / Analyze with starter Evaluate, DOK 2-3.",
    recommended_question_types:
      "Multi-part MCQs, short evidence-based responses, choose-and-justify items, cloze passages, one-paragraph writing prompts, and graph/table interpretation questions.",
  },
  6: {
    target_thinking_level: "Analyze + Apply with more open-ended questions, DOK 2-3.",
    recommended_question_types:
      "MCQs on multi-step situations, short constructed responses of 3-4 sentences, relationship analysis, error analysis, basic argument questions, and fill-in tables/diagrams.",
  },
  7: {
    target_thinking_level: "Analyze / Evaluate, DOK 2-3 with some DOK 4.",
    recommended_question_types:
      "Scenario-based MCQs, extended short answers with evidence, justification questions with multiple reasons, compare-source questions, classify-and-explain tasks, and design-a-solution prompts with constraints.",
  },
  8: {
    target_thinking_level: "Analyze / Evaluate / beginning Create, with some DOK 3-4 items.",
    recommended_question_types:
      "Complex best-answer MCQs, constructed responses citing text/data evidence, author-purpose or point-of-view questions, compare/evaluate arguments or methods, model/experiment design prompts, and hypothetical what-if reasoning questions.",
  },
  9: {
    target_thinking_level: "Analyze / Evaluate / Create, DOK 2-4.",
    recommended_question_types:
      "Passage-based MCQs, short essays of 1-2 paragraphs, complex graph/table interpretation, error analysis and improve-the-solution tasks, debate-style prompts, and simple project-planning questions.",
  },
  10: {
    target_thinking_level: "Strong Analyze / Evaluate with frequent Create tasks, DOK 3-4.",
    recommended_question_types:
      "Multi-source items, analytical essay prompts, constructed responses requiring reasoning chains, evaluate-solution or evaluate-argument tasks, experiment/model design prompts, and transform/reframe/generalize tasks.",
  },
  11: {
    target_thinking_level: "High-level Evaluate / Create, DOK 3-4.",
    recommended_question_types:
      "AP/SAT-style MCQs, long constructed responses, synthesis questions using multiple sources, critique and revision tasks, project design outlines, and extend-the-model or extend-the-theory questions.",
  },
  12: {
    target_thinking_level: "Independent Evaluate / Create and synthesis, DOK 3-4.",
    recommended_question_types:
      "College-readiness MCQs, extended analytical writing, synthesis across sources/data, evaluation using criteria, proposal/design prompts with predicted outcomes, and transfer questions applying concepts to unfamiliar contexts.",
  },
};
