...
const lessonPlanSectionSchema = z
  .object({
...
const lessonPlanSchema = z
  .object({
    ...
    concept_introduction: lessonPlanSectionSchema
      .extend({
        key_terms: stringArray.optional(),
      })
      .catchall(z.unknown()),
    guided_activity: lessonPlanSectionSchema
      .extend({
        materials: stringArray.optional(),
      })
      .catchall(z.unknown()),
    recap: lessonPlanSectionSchema
      .extend({
...
const mcqSchema = questionSchema
  .extend({
    options: z
...
const worksheetSectionSchema = z
  .object({
...
export const lessonKitSchema = z
  .object({
