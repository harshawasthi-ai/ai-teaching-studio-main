  ...
  return (
    <div className="min-h-screen relative">
      ...
      <main className="relative max-w-4xl mx-auto px-4 sm:px-6 py-10">
        <div
          className="rounded-3xl border border-white/10 backdrop-blur-xl p-8 sm:p-10"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-5">
            ...
            <div>
              <p className="text-blue-300 text-sm font-semibold">
                {profile?.grade || "Student workspace"}
              </p>
              <h1 className="text-white text-3xl font-bold mt-1">Your Lessons</h1>
              <p className="text-blue-200 mt-2">
                Lessons assigned to your grade will appear here. You will be able to open
                worksheets, answer questions, and submit your work.
              </p>
            </div>
          </div>
          <button
        ...
        {lessons === null ? (
          <div
            className="mt-6 rounded-3xl border border-white/10 backdrop-blur-xl p-8 text-center"
          ...
          >
            ...
            <p className="text-blue-200 text-sm mt-2">
              Checking what has been published for {profile?.grade || "your grade"}.
            </p>
          </div>
        ) : lessons.length === 0 ? (
          <div
          ...
          >
            ...
            <p className="text-blue-200 text-sm mt-2">
              Once a teacher publishes lessons for {profile?.grade || "your grade"}, they will show
              up here.
            </p>
          </div>
        ) : (
